...
// Create a transporter for sending emails via Spaceship SMTP
...
exports.sendContactEmail = functions.firestore
  ...
  .onCreate(async (snapshot, context) => {
    try {
      ...
      // Email content - send notification to support@labinitial.com
      const mailOptions = {
        from: `"Labinitial Contact Form" <${functions.config().email.user}>`,
          ...
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #ddd; text-align: center;">
              <p style="color: #666; font-size: 12px;">
                This email was automatically generated by your Labinitial contact form.
              </p>
            </div>
          </div>
        `
...
exports.testEmail = functions.https.onRequest(async (req, res) => {
  try {
    const mailOptions = {
      from: `"Labinitial Test" <${functions.config().email.user}>`,
      to: functions.config().email.user,
      subject: 'Test Email from Labinitial Firebase Function',
      text: 'This is a test email from your Labinitial Firebase Function. If you receive this, the email system is working!'
    };
